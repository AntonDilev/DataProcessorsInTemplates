...
// Подготавливает контекст обработки, восстанавливая настройки и инициализируя параметры.
// Вызывается из ПриСозданииНаСервере формы обработки.
//
&НаСервере
...
// Устанавливает ограничения типов для полей формы на основе данных, полученных из модуля интеграции.
// Вызывается из ПриОткрытии формы обработки.
//
&НаКлиенте
...
#Область ВызовМетодовИнтеграцииИзФормы
